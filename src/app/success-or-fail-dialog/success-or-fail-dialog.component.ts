...
@Component({
  ...
  standalone: true,
  imports: [MatButtonModule, MatDialogContent, MatDialogActions, MatDialogClose, MatInputModule, CommonModule, RouterModule
...
export class SuccessOrFailDialogComponent{
  textOfSuccessOrFail='';
  constructor(public dialogRef: MatDialogRef<SuccessOrFailDialogComponent>, @Inject(MAT_DIALOG_DATA) public data: any) {
